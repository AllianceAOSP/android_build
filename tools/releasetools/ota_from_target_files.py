...
""" % bcb_dev)
  ...
  script.Print("                       ......")
  script.Print("                    `s.sMMMMM+")
  script.Print("                   `dMN:+MMMMMs")
  script.Print("                  .mMMMM/:NMMMMh`")
  script.Print("                 :NMMMMMMo-mMMMMd`")
  script.Print("                /MMMMMMMMMy.dMMMMm-")
  script.Print("               oMMMMN+mMMMMd.yMMMMN:")
  script.Print("              yMMMMm-/.dMMMMm-oMMMMM+")
  script.Print("             dMMMMd.yMh.hMMMMN:/MMMMMo")
  script.Print("           .mMMMMh.dMMMd sMMMMM+:NMMMMy.")
  script.Print("          -NMMMMs.mMMMN-  oMMMMMs.mMMMMd`")
  script.Print("         /MMMMM+-NMMMd.    /MMMMMh.dMMMMm.")
  script.Print("        oMMMMN//NMMMh`      :NMMMMd.yMMMMN:")
  script.Print("       yMMMMN-oMMMMs         .mMMMMm-oMMMMM.")
  script.Print("      hMMMMm.sMMMM+           `yhyhhy`/MMMMMo")
  script.Print("    .mMMMMh.hMMMN:/hhhhhhhhhhhhhhhhhhhhmMMMMMy")
  script.Print("   'NMMMMy.dMMMN-oMMMMMMMMMMMMMMMMMMMMMMMMMMMMd.")
  script.Print("  /NMMMMo-mMMMd.yMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMm.")
  script.Print(" +MMMMM/:NMMMh`-++++++++++++++++++++++++++++++++/")
  script.Print(" +MMMN:+MMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMm`")
  script.Print("  +Mm-sMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMM/")     
  script.Print("   :.yNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNh")
  script.Print(" ") 
  script.Print("Flashing Alliance...")          
